...
const styles = StyleSheet.create({
  addPButton: {
    ...
    height: 60, // Ensures the button is a perfect circle
    borderRadius: 30, // Half the size of width and height for a perfect circle
    justifyContent: 'center',
    alignItems: 'center',
    position: 'absolute', // Position it absolutely on the screen
    bottom: 25, // Adjust the distance from the bottom of the screen
    right: 15, // Aligns the button to the right side of the screen
    shadowColor: '#000',
